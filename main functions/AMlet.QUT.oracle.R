AMlet.QUT.oracle<-function(y,X,lambda=NA,sigma,p0=1,filter.number=1,family="DaubExPhase",bc="periodic",
  ...
  if(is.na(sigma)){print('Please give a value for sigma!');out=NULL;}
  if(P>1){
