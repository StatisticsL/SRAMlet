lambdaQUT.sqrtAMlet.Linear<-function(X,filter.number=1,family="DaubExPhase", bc="periodic",
  ...
  lambda.QUT.S=lambdaQUT.sqrtAMlet(X=X,filter.number=filter.number,family=family, bc=bc,
