lambdaQUT.sqrtAMlet.Haar<-function(X,filter.number=1,family="DaubExPhase", bc="periodic",
  ...
  if(type=='MC'){
    ...
    lambdas1=num/den
    num2=apply(z,2,numfct,Xorder=Xorder,filter.number=1,family="DaubExPhase", bc=bc)
    lambdas2=num2/den
    #lambdas=c(lambdas1,lambdas2)
