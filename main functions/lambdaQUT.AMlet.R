lambdaQUT.AMlet<-function(X,sigma,filter.number=1,family="DaubExPhase", bc="periodic",
  ...
  if(type=='MC'){
    ...
    lambdas=apply(z,2,numfct,Xorder=Xorder,filter.number=filter.number,family=family, bc=bc)
